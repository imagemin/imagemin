...
Set name of file without extension. Extension would be automatically added by `buffer-to-vynil` module. If you don't set
any filename it would be generated by uuid.
